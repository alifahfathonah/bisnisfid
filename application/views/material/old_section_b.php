 <ul class="nav nav-tabs">
    <li><a href="material">Section A</a></li>
    <li class="active"><a href="#">Section B</a></li>
 </ul>
     <div class="news-masonry">
                            ...
                            <div class="row mas-m">
                                <div class="col-xs-6 col-sm-6 mas-p">
                                    <div class="masonry-slide1 owl-carousel owl-theme" style="opacity: 1; display: block;">
                                        <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 1128px; left: 0px; display: block; transition: all 1000ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 282px;"><div class="item mas-m-b">
                                            <div class="mas-item masonry-sm">
                                                <figure><img src="<?php echo base_url(); ?>assets/learning/5898844fcc0a3e9932978c53a8608de6.png" class="img-responsive" alt=""></figure>  
                                                <div class="mas-text">
                                                    <div class="post-cat"><a href="#">Document</a></div>
                                                    <h4 class="mas-title"><a href="#">HTML Learning Material</a></h4>
                                                    <div class="mas-details">
                                                        <p></p>
                                                        <a href="<?php echo base_url(); ?>assets/learning/385e9f000a3d25b173d87d63d4ec5f54.pdf" class="read-more">Download</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /.End of masonry item -->
                                ...
                                <div class="col-xs-6 col-sm-6 mas-p">
                                    <div class="masonry-sm owl-carousel owl-theme" style="opacity: 1; display: block;">
                                        <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 1128px; left: 0px; display: block; transition: all 1000ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 282px;"><div class="item">
                                            <div class="mas-item masonry-sm">
                            ...
                            <div class="row mas-m">
                                <div class="col-xs-6 col-sm-6 mas-p">
                                    <div class="masonry-slide1 owl-carousel owl-theme" style="opacity: 1; display: block;">
                                        <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 1128px; left: 0px; display: block; transition: all 1000ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 282px;"><div class="item mas-m-b">
                                            <div class="mas-item masonry-sm">
                                                <figure><img src="<?php echo base_url(); ?>assets/learning/b4eb379c53c6f479f486bbba30851ca2.png" class="img-responsive" alt=""></figure>  
                                                <div class="mas-text">
                                                    <div class="post-cat"><a href="#">Document</a></div>
            ...
            <div class="page-content" style="transform: none;">
                    ...
                    <div class="row" style="transform: none;">
                        ...
                        <div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none; top: 0px; left: 189.6px;"><div class="trending-post">
                                ...
                                <div class="single-post">
                                  ...
                                  <a href="material/seemorefiles/B">See More</a>
                                </div>
                        ...
                        <div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none;"><article class="grid_post grid_post_lg text-center">
                                ...
                                <div class="item vide_post_item">
                                    ...
                                    <div class="videoWrapper videoWrapper169 js-videoWrapper">
                                      ...
                                      <figure><iframe class="videoIframe js-videoIframe" src="https://www.youtube.com/embed/g3YlIlIIjWg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen ></iframe></figure>
                                    </div>
                        ...
                        <div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none; top: 0px; left: 1067.1px;"><div class="latest_post_widget">
                                <div class="title-holder">
                ...
                <div class="media latest_post">
                                    <a href="material/seemorevideos/B">See More</a>
                                </div>
                                <!-- /.latest post -->
                            </div>
                                <!-- /.End of category -->
